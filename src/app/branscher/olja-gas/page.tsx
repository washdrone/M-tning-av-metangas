    ...
    <>
      ...
      <section className="section-padding bg-dimma border-t border-mossa">
        <div className="container-narrow">
          <h2 className="text-2xl font-bold sm:text-3xl text-skiffer">Olje- och gasindustrin under regulatoriskt tryck</h2>
      ...
      <section className="section-padding">
        <div className="container-narrow">
          <h2 className="text-2xl font-bold sm:text-3xl text-skiffer">Tjänster för olja och gas</h2>
      ...
      <section className="section-padding bg-dimma border-t border-mossa">
        <div className="container-narrow">
          <h2 className="text-2xl font-bold sm:text-3xl text-skiffer">EU:s metanförordning – vad den kräver</h2>
          ...
          <p className="mt-6 text-aska">
            Läs mer om{' '}
            <Link href="/compliance/eu-metanforordning" className="text-jarnmalm hover:underline">EU:s metanförordning och dess LDAR-krav</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container-narrow">
          <h2 className="text-2xl font-bold sm:text-3xl text-skiffer">OGMP 2.0 – metanrapportering på hög nivå</h2>
          <p className="mt-4 text-kol leading-relaxed">
          ...
          <p className="mt-6 text-aska">
            Läs mer om{' '}
            <Link href="/compliance/ogmp" className="text-jarnmalm hover:underline">OGMP 2.0 och hur EcoDrone stödjer er rapportering</Link>.
          </p>
        </div>
      </section>
      ...
      <section className="section-padding bg-dimma border-t border-mossa">
        <div className="container-narrow">
          <h2 className="text-2xl font-bold sm:text-3xl text-skiffer">Så går en LDAR-inspektion till</h2>
      ...
      <section className="section-padding">
        <div className="container-narrow">
          <h2 className="text-2xl font-bold sm:text-3xl text-skiffer">Säkerhet vid inspektion</h2>
          <p className="mt-4 text-kol leading-relaxed">
      ...
      <section className="section-padding">
        <div className="container-narrow">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            ...
            <Link href="/branscher/hamnar" className="border border-mossa bg-white px-4 py-2.5 text-sm text-kol hover:text-kol hover:border-feltsten transition-colors">
