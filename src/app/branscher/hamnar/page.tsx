    ...
    <>
      ...
      <section className="section-padding section-muted">
        <div className="container-narrow">
          <h2 className="text-2xl font-bold sm:text-3xl text-slate-900">Emissionsövervakning vid hamnar och LNG-infrastruktur</h2>
      ...
      <section className="section-padding">
        <div className="container-narrow">
          <h2 className="text-2xl font-bold sm:text-3xl text-slate-900">Tjänster för hamnar och LNG-terminaler</h2>
      ...
      <section className="section-padding section-muted">
        <div className="container-narrow">
          <h2 className="text-2xl font-bold sm:text-3xl text-slate-900">EU:s metanförordning och hamninfrastruktur</h2>
          <p className="mt-4 text-slate-700 leading-relaxed">
      ...
      <section className="section-padding">
        <div className="container-narrow">
          <h2 className="text-2xl font-bold sm:text-3xl text-slate-900">Säkerhet och Seveso-klassificering</h2>
          <p className="mt-4 text-slate-700 leading-relaxed">
      ...
      <section className="section-padding section-muted">
        <div className="container-narrow">
          <h2 className="text-2xl font-bold sm:text-3xl text-slate-900">Leverabler och dokumentation</h2>
          <p className="mt-4 text-slate-700 leading-relaxed">
