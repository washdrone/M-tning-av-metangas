...
export function Header() {
  ...
  return (
    ...
    >
      ...
      {mobileOpen && (
        <div className="fixed inset-x-0 top-[calc(200px+env(safe-area-inset-top))] bottom-0 overflow-y-auto border-t border-dark-800 bg-dark-950/98 backdrop-blur-xl lg:hidden">
